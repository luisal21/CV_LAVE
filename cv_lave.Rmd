---
title: "Luis Alberto Villanueva-Espino's CV"
author: Luis Alberto Villanueva Espino 
...
CV <- create_CV_object(
  data_location = "https://docs.google.com/spreadsheets/d/15Dlu_GRHEvsxBDYGC7k2T0WT_GEduKGtx-_QPKx6_oY/edit?usp=sharing",  
  pdf_mode = params$pdf_mode
 )
...
The source code is available at [luisal21/CV_LAVE](https://github.com/luisal21/CV_LAVE) and is powered by [nstrayer/cv](https://github.com/nstrayer/cv).
...
Luis Alberto Villanueva Espino {#title}
--------------------------------------------------------------------------------
